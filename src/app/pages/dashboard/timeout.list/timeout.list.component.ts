...
@Component({
  selector: 'app-timeout-list',
  templateUrl: './timeout.list.component.html',
  styleUrls: ['./timeout.list.component.scss']
})
export class TimeoutListComponent implements OnInit{
  public router;
  public token: any;
  public org_id: any;
  public userId: any;
  ...
  getTimeIn(): void {
    this.attendService.getEventDetail(this.token, this.userId, this.org_id, 'timeout').subscribe((data: any) => {
