...
import { verticalMenuItemsMember, verticalMenuItems, horizontalMenuItems1Member } from './menu';
import { subsMenuItems } from './menu';
...
export class MenuService {
  ...
  constructor(private location: Location,
    ...
    this.roleAccess = this.tokenService.getRoleAccess()
  ...
  public getsubsMenuItems(): Array<Menu> {
    return subsMenuItems;
  }
  public getHorizontalMenuItems(): Array<Menu> {
    return horizontalMenuItems;
  }
  public  getVerticalMenuItemsMember(): Array<Menu> {
    return verticalMenuItemsMember;
  }
  public  horizontalMenuItems1Member(): Array<Menu> {
    return horizontalMenuItems1Member;
  }
  ...
  public createMenu(menu: Array<Menu>, nativeElement, type) {
    ...
    if (type == 'subs') {
      this.createSubsMenu(menu, nativeElement);
    }
  }
  ...
  public createSubsMenu(menu: Array<Menu>, nativeElement) {
    let menu0 = this.renderer2.createElement('div');
    this.renderer2.setAttribute(menu0, 'id', 'menu0');
    menu.forEach((menuItem) => {
      if (menuItem.parentId == 0) {
        let subMenu = this.createSubsMenuItem(menu, menuItem);
        this.renderer2.appendChild(menu0, subMenu);
      }
    });
    this.renderer2.appendChild(nativeElement, menu0);
  ...
  public createSubsMenuItem(menu: Array<Menu>, menuItem) {
    let div = this.renderer2.createElement('div');
    this.renderer2.addClass(div, 'card');
    this.renderer2.setAttribute(div, 'id', 'menu' + menuItem.id);
    let link = this.renderer2.createElement('a');
